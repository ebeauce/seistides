...
class Modulationmeter(object):
    ...
    def __init__(self, short_window_days=None, num_short_windows=None,
            overlap=None, downsample=None, catalog=None, forcing=None,
        ...
        """
        assert window_type in {"forward", "backward"}, "window_type should be either of 'backward' or 'forward'."
    ...
    def fit_modulation(self, func, window_time, forcing_name,
        model_name="model1", **kwargs):
        """
        """
        if forcing_name not in self.model:
